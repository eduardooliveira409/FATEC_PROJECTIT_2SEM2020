<%@ Page Title="" Language="C#" MasterPageFile="~/layout.Master" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="ANIMALE_PETSHOP.Cadastros.Cliente" %>
        ...
        <form>
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="txtCli" runat="server" placeholder="Digite um nome">
            </div>
            <div class="form-group">
